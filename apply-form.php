...
<p style="padding-top: 20px; font-size: 15px"><strong>Training Time: &nbsp &nbsp &nbsp &nbsp  </strong>
					...
					<p>	<input type="password" name="password" placeholder="Your Password" required="true"></p></br>
